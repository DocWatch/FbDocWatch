...
](/docs/graph-api/webhooks) . This will walk you through the general setup,
...
Subscribes to [ Message Received events ](message-received)  
  
` message_deliveries `

|

Subscribes to [ Message Delivered events ](message-delivered)  
  
` message_reads `

|

Subscribes to [ Message Read events ](message-read)  
  
` message_echoes `

|

Subscribes to [ Message Echo events ](message-echo)  
  
` messaging_postbacks `

|

Subscribes to [ Postback Received events ](postback-received)  
...
Subscribes to [ Referral events ](referral)  
  
` messaging_checkout_updates ` (BETA)

|

Subscribes to [ Checkout Update events ](checkout-update)  
  
` messaging_payments ` (BETA)

|

Subscribes to [ Payment events ](payment)  
  
` messaging_account_linking `

|

Subscribes to [ Account Linking events ](account-linking)  
  
Payment-related callbacks are in beta and will only appear to developers who
have access. [ Request access to our beta program for payments
](https://www.facebook.com/messenger_platform/payments_requestaccess) .

![](https://scontent.xx.fbcdn.net/t39.2365-6/14050177_1818094655103267_1221918034_n.png)
...
![](https://scontent.xx.fbcdn.net/t39.2365-6/13466568_984470978337660_125967052_n.png)
...
by Facebook. Failing to do so may cause your webhook to be  unsubscribed  by
...
has acknowledged the message. You can also use [ Sender Actions
](/docs/messenger-platform/send-api-reference/sender-actions) to notify that
...
your app. Once you've fixed your issues, you must re-add your webhook and [
re-subscribe your app to the page
](https://developers.intern.facebook.com/docs/messenger-platform/webhook-
reference#subsribe) .

![](https://scontent.xx.fbcdn.net/t39.2365-6/13480194_134179967005698_496318901_n.png)
